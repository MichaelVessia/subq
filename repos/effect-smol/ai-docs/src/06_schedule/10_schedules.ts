...
export const retryBackoffWithLimit = Schedule.both(Schedule.exponential('250 millis'), Schedule.recurs(6))
...
export const keepTryingUntilBothStop = Schedule.either(Schedule.spaced('2 seconds'), Schedule.recurs(3))
