...
export const samples = Stream.fromEffectSchedule(Effect.succeed(3), Schedule.spaced('30 seconds')).pipe(
...
export const letters = Stream.fromAsyncIterable(asyncIterable(), (cause) => new LetterError({ cause }))
