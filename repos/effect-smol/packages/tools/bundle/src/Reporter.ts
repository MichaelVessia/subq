...
export class Reporter extends Context.Service<Reporter>()('@effect/bundle/Reporter', {
  make: Effect.gen(function* () {
    ...
    const reportSelected = Effect.fn('Reporter.reportSelected')(function* (options: ReportSelectedOptions) {
  ...
  static readonly layer = Layer.effect(this, this.make).pipe(Layer.provide(Fixtures.layer), Layer.provide(Rollup.layer))
}
