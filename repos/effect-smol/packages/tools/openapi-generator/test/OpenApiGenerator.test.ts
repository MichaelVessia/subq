...
export const CreatePayloadRequestText = Schema.String`,
        ...
        ['Schema.Opaque', `extends Schema.Class<CreatePayloadRequestJson>("CreatePayloadRequestJson")`],
      ),
    )
          ...
          paths: {
            '/secure': {
              get: {
                ...
                tags: ['Security'],
                security: [{ apiKeyAuth: [] }, { bearerAuth: [] }, { apiKeyAuth: [], basicAuth: [] }],
              },
            },
            '/public': {
              get: {
    ...
    it.effect('emits lossy warnings and skips unsupported httpapi operations', () =>
      assertHttpApiWithWarnings(
        ...
        },
        {
          ...
          excludes: [`HttpApiEndpoint.get("streamEvents", "/sse"`, `HttpApiEndpoint.get("getNoBody", "/nobody"`],
          warnings: [
            {
