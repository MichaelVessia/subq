 ...
 * @since 2.0.0
 */
export const fromReasons: <E>(reasons: ReadonlyArray<Reason<E>>) => Cause<E> = core.causeFromReasons
 ...
 * @since 4.0.0
 */
export class InterruptorStackTrace extends Context.Service<InterruptorStackTrace, StackFrame>()(
