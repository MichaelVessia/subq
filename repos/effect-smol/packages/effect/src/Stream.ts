...
export const catchIf: {
  ...
  <A, E, R, A2, E2, R2, A3 = never, E3 = E, R3 = never>(
    ...
    fromChannel(Channel.catchIf(toChannel(self), predicate, (e) => f(e).channel, orElse && ((e) => orElse(e).channel))),
)
...
export const catchFilter: {
  ...
  <A, E, R, EB, A2, E2, R2, X, A3 = never, E3 = X, R3 = never>(
    ...
    fromChannel(
      Channel.catchFilter(toChannel(self), filter, (e) => f(e).channel, orElse && ((e) => orElse(e).channel)),
    ),
)
...
export const catchCauseIf: {
  ...
  <A, E, R, A2, E2, R2>(
    ...
    fromChannel(Channel.catchCauseIf(self.channel, predicate, (cause) => f(cause).channel)),
)
...
export const catchCauseFilter: {
  ...
  <A, E, R, EB, A2, E2, R2, X extends Cause.Cause<any>>(
    ...
    fromChannel(Channel.catchCauseFilter(self.channel, filter, (failure, cause) => f(failure, cause).channel)),
)
...
export const takeWhile: {
  ...
  2,
  <A, E, R>(self: Stream<A, E, R>, predicate: (a: A, n: number) => boolean): Stream<A, E, R> =>
    transformPull(self, (pull, _scope) =>
      Effect.sync(() => {
        let i = 0
        let done = false
...
export const takeWhileFilter: {
  ...
  2,
  <A, E, R, B, X>(self: Stream<A, E, R>, filter: Filter.Filter<NoInfer<A>, B, X>): Stream<B, E, R> =>
    transformPull(self, (pull, _scope) =>
      Effect.sync(() => {
        let done = false
...
export const dropWhile: {
  ...
  2,
  <A, E, R>(self: Stream<A, E, R>, predicate: (a: A, index: number) => boolean): Stream<A, E, R> =>
    transformPull(self, (pull, _scope) =>
      Effect.sync(() => {
        let dropping = true
        let index = 0
...
export const updateContext: {
  ...
  2,
  <A, E, R, R2>(self: Stream<A, E, R>, f: (context: Context.Context<R2>) => Context.Context<R>): Stream<A, E, R2> =>
    fromChannel(Channel.updateContext(self.channel, f)),
)
...
export const updateService: {
  ...
  <A, E, R, I, S>(
    ...
    updateContext(self, (context) => Context.add(context, service, f(Context.get(context, service)))),
)
...
export const toReadableStream: {
  ...
  (args) => isStream(args[0]),
  <A, E>(self: Stream<A, E>, options?: { readonly strategy?: QueuingStrategy<A> | undefined }): ReadableStream<A> =>
    toReadableStreamWith(self, Context.empty(), options),
)
...
export const toReadableStreamEffect: {
  ...
  <A, E, R>(
    ...
    Effect.map(Effect.context<R>(), (context) => toReadableStreamWith(self, context, options)),
)
...
export const toAsyncIterableEffect = <A, E, R>(self: Stream<A, E, R>): Effect.Effect<AsyncIterable<A>, never, R> =>
  Effect.map(Effect.context<R>(), (context) => toAsyncIterableWith(self, context))
