 ...
 * @category errors
 */
export const SocketErrorReason = Schema.Union([SocketReadError, SocketWriteError, SocketOpenError, SocketCloseError])
 ...
 * @category tags
 */
export class WebSocket extends Context.Service<WebSocket, globalThis.WebSocket>()('~effect/socket/Socket/WebSocket') {}
