...
export const setHeader: {
  ...
  3,
  (self: HttpClientRequest, key: string, value: string): HttpClientRequest =>
    makeWith(self.method, self.url, self.urlParams, self.hash, Headers.set(self.headers, key, value), self.body),
)
...
export const setHeaders: {
  ...
  2,
  (self: HttpClientRequest, input: Headers.Input): HttpClientRequest =>
    makeWith(self.method, self.url, self.urlParams, self.hash, Headers.setAll(self.headers, input), self.body),
)
...
export const setUrlParam: {
  ...
  3,
  (self: HttpClientRequest, key: string, value: string): HttpClientRequest =>
    makeWith(self.method, self.url, UrlParams.set(self.urlParams, key, value), self.hash, self.headers, self.body),
)
...
export const setUrlParams: {
  ...
  2,
  (self: HttpClientRequest, input: UrlParams.Input): HttpClientRequest =>
    makeWith(self.method, self.url, UrlParams.setAll(self.urlParams, input), self.hash, self.headers, self.body),
)
...
export const appendUrlParam: {
  ...
  3,
  (self: HttpClientRequest, key: string, value: string): HttpClientRequest =>
    makeWith(self.method, self.url, UrlParams.append(self.urlParams, key, value), self.hash, self.headers, self.body),
)
...
export const appendUrlParams: {
  ...
  2,
  (self: HttpClientRequest, input: UrlParams.Input): HttpClientRequest =>
    makeWith(self.method, self.url, UrlParams.appendAll(self.urlParams, input), self.hash, self.headers, self.body),
)
