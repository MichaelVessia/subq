 ...
 * @category HttpRouter
 */
export const HttpRouter: Context.Service<HttpRouter, HttpRouter> = Context.Service<HttpRouter>('effect/http/HttpRouter')
 ...
 */
export const RouterConfig = Context.Reference<Partial<FindMyWay.RouterConfig>>('effect/http/HttpRouter/RouterConfig', {
  defaultValue: () => ({}),
})
