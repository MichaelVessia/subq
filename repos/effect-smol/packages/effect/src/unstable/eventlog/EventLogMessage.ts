 ...
 * @category protocol
 */
export class SingleMessage extends Schema.TaggedClass<SingleMessage>('effect/eventlog/EventLogRemote/SingleMessage')(
  'Single',
  {
 ...
 * @category protocol
 */
export class ChunkedMessage extends Schema.TaggedClass<ChunkedMessage>('effect/eventlog/EventLogRemote/ChunkedMessage')(
  'Chunked',
  {
    id: Schema.Number,
