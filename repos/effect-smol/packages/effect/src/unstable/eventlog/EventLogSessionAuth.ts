...
const encodeRemoteIdField = (remoteId: string | Uint8Array): Uint8Array =>
  typeof remoteId === 'string' ? textEncoder.encode(remoteId) : textEncoder.encode(bytesToHex(remoteId))
 ...
 * @category challenge
 */
export const makeSessionAuthChallenge: Effect.Effect<Uint8Array<ArrayBuffer>, EventLogSessionAuthError> = Effect.gen(
  function* () {
