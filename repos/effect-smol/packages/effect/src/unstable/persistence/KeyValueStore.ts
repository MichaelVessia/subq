 ...
 * @category layers
 */
export const layerSql = (options: LayerSqlOptions = {}): Layer.Layer<KeyValueStore, never, SqlClient.SqlClient> =>
  Layer.effect(KeyValueStore)(
    Effect.gen(function* () {
      ...
      type UpsertFn = (entry: { id: string; value: Uint8Array; value_type: number }) => Effect.Effect<unknown, SqlError>
