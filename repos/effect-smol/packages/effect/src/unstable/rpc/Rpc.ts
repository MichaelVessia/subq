 ...
 */
export const custom =
  <Def extends Custom>(f: (options: Custom.OutDefault) => (Def & Custom.OutDefault)['out']) =>
  <
    const Tag extends string,
    Payload extends Schema.Top | Schema.Struct.Fields = Schema.Void,
    Success extends Schema.Top = Schema.Void,
...
export declare namespace Custom {
   ...
   * @category Custom constructors
   */
  export type Kind<Def extends Custom, Success extends Schema.Top, Error extends Schema.Top> = (Def & {
    readonly success: Success
    readonly error: Error
  })['out']
}
