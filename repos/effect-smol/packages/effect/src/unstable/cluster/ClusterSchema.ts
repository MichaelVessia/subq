 ...
 * @category Annotations
 */
export const WithTransaction = Context.Reference<boolean>('effect/cluster/ClusterSchema/WithTransaction', {
  defaultValue: constFalse,
})
 ...
 * @category Annotations
 */
export const ShardGroup = Context.Reference<(entityId: EntityId) => string>('effect/cluster/ClusterSchema/ShardGroup', {
