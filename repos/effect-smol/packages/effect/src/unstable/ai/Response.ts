 ...
 * @category schemas
 */
export const ProviderMetadata: Schema.$Record<Schema.String, Schema.NullOr<Schema.Codec<Schema.Json>>> = Schema.Record(
  Schema.String,
...
export const ToolCallPart: <const Name extends string, Params extends Schema.Top>(
  ...
  readonly '~effect/ai/Content/Part': Schema.withDecodingDefaultKey<Schema.tag<'~effect/ai/Content/Part'>>
  readonly metadata: Schema.withDecodingDefault<Schema.$Record<Schema.String, Schema.Codec<Schema.Json>>>
}> = <const Name extends string, Params extends Schema.Top>(name: Name, params: Params) =>
  Schema.Struct({
    ...BasePart.fields,
