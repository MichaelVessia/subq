 ...
 * @category services
 */
export class LanguageModel extends Context.Service<LanguageModel, Service>()('effect/unstable/ai/LanguageModel') {}
 ...
 */
export type ToolkitOption<Tools extends Record<string, Tool.Any>, E = never, R = any> = Tools extends any
...
export const generateText: {
  ...
  >
} = (options: GenerateTextOptions<any>): Effect.Effect<GenerateTextResponse<any>, AiError.AiError, LanguageModel> =>
...
export const streamText: {
  ...
  >(
    ...
    ExtractServices<Options> | LanguageModel
  >
} = (options: GenerateTextOptions<any>): Stream.Stream<Response.StreamPart<{}>, AiError.AiError, LanguageModel> =>
...
const resolveStructuredOutput = Effect.fnUntraced(function* <StructuredOutputSchema extends Schema.Top>(
