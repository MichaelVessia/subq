 ...
 * @category services
 */
export class EmbeddingModel extends Context.Service<EmbeddingModel, Service>()('effect/unstable/ai/EmbeddingModel') {}
 ...
 * @category services
 */
export class Dimensions extends Context.Service<Dimensions, number>()('effect/unstable/ai/EmbeddingModel/Dimensions') {}
 ...
 * @category models
 */
export class EmbeddingUsage extends Schema.Class<EmbeddingUsage>('effect/ai/EmbeddingModel/EmbeddingUsage')({
 ...
 * @category models
 */
export class EmbedResponse extends Schema.Class<EmbedResponse>('effect/ai/EmbeddingModel/EmbedResponse')({
 ...
 * @category models
 */
export class EmbedManyResponse extends Schema.Class<EmbedManyResponse>('effect/ai/EmbeddingModel/EmbedManyResponse')({
...
export const make: (params: {
  ...
  return EmbeddingModel.of({
    resolver,
    embed: (input) =>
      Effect.request(new EmbeddingRequest({ input }), resolver).pipe(Effect.withSpan('EmbeddingModel.embed')),
    embedMany: (input) =>
      (input.length === 0
        ? Effect.succeed(
