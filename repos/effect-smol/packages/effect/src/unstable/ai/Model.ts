 ...
 * @category services
 */
export class ProviderName extends Context.Service<ProviderName, string>()('effect/unstable/ai/Model/ProviderName') {}
 ...
 * @category services
 */
export class ModelName extends Context.Service<ModelName, string>()('effect/unstable/ai/Model/ModelName') {}
