 ...
 * @category models
 */
export const ProviderOptions: Schema.$Record<Schema.String, Schema.NullOr<Schema.Codec<Schema.Json>>> = Schema.Record(
  Schema.String,
  Schema.NullOr(Schema.Json),
)
...
export const AssistantMessage: Schema.Struct<{
  ...
  content: Schema.Union([
    ContentFromString,
    Schema.Array(
      Schema.Union([TextPart, FilePart, ReasoningPart, ToolCallPart, ToolResultPart, ToolApprovalRequestPart]),
    ),
  ]),
