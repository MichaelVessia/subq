 ...
 * @category reason
 */
export class InvalidOutputError extends Schema.ErrorClass<InvalidOutputError>('effect/ai/AiError/InvalidOutputError')({
 ...
 * @category reason
 */
export class ToolNotFoundError extends Schema.ErrorClass<ToolNotFoundError>('effect/ai/AiError/ToolNotFoundError')({
