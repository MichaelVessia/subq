 ...
 * @category constructors
 */
export const fromExport = (data: unknown): Effect.Effect<Service, Schema.SchemaError> =>
 ...
 * @category constructors
 */
export const fromJson = (data: string): Effect.Effect<Service, Schema.SchemaError> =>
...
export class Persistence extends Context.Service<Persistence, Persistence.Service>()('effect/ai/Chat/Persisted') {}
