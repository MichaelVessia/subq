...
export class WorkflowEngine extends Context.Service<
  WorkflowEngine,
  {
    ...
    ) => Effect.Effect<Option.Option<Exit.Exit<Success['Type'], Error['Type']>>, never, WorkflowInstance>
  ...
  WorkflowEngine.of({
    ...
    deferredResult: Effect.fnUntraced(
      function* <Success extends Schema.Top, Error extends Schema.Top>(
        ...
        return Option.some(
          yield* Effect.orDie(Schema.decodeEffect(deferred.exitSchema)(toJsonExit(exit.value))) as Effect.Effect<
