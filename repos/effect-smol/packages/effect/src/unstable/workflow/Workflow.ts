      ...
      Effect.matchCauseEffect({
        ...
        onFailure: (cause): Effect.Effect<Result<A, E>> => {
          ...
          return instance.suspended && hasInterruptsOnly
            ...
            : (!instance.interrupted && hasInterruptsOnly) || (!captureDefects && Cause.hasDies(cause))
 ...
 */
export const CaptureDefects = Context.Reference<boolean>('effect/workflow/Workflow/CaptureDefects', {
 ...
 * @category Annotations
 */
export const SuspendOnFailure = Context.Reference<boolean>('effect/workflow/Workflow/SuspendOnFailure', {
