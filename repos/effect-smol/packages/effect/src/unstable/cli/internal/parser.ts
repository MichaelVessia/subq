...
const resolveFlag = (token: FlagToken, registry: FlagRegistry): ResolvedFlag | undefined => {
...
const invalidNegatedFlagValue = (token: FlagToken, spec: FlagParam, value: string): CliError.InvalidValue =>
