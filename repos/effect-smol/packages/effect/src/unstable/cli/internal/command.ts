 ...
 */
export interface CommandInternal<Name extends string, Input, E, R, ContextInput> extends Command<
  Name,
  Input,
  ContextInput,
  E,
...
export const makeCommand = <const Name extends string, Input, E, R, ContextInput = {}>(options: {
  ...
  return Object.assign(Object.create(Proto), {
    ...
    ...(Predicate.isNotUndefined(options.shortDescription) ? { shortDescription: options.shortDescription } : {}),
    ...(Predicate.isNotUndefined(options.alias) ? { alias: options.alias } : {}),
  })
}
