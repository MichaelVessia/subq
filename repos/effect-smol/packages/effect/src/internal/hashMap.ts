...
function mergeLeaves<K, V>(
  ...
  const children: Array<Node<K, V>> = bit1 >>> 0 < bit2 >>> 0 ? [node1, node2] : [node2, node1]
...
class ArrayNode<K, V> extends Node<K, V> {
  ...
  private pack(edit: number, excludeIdx: number, newChild: Node<K, V> | undefined): IndexedNode<K, V> {
