 ...
 * @since 4.0.0
 */
export const durationFromString: Transformation<Duration.Duration, string> = transformOrFail<Duration.Duration, string>(
  {
    decode: (s) =>
...
export const durationFromNanos: Transformation<Duration.Duration, bigint> = transformOrFail({
  ...
  encode: (a) =>
    Option.match(Duration.toNanos(a), {
      onNone: () =>
        Effect.fail(new Issue.InvalidValue(Option.some(a), { message: `Unable to encode ${a} into a bigint` })),
 ...
 * @since 4.0.0
 */
export const timeZoneFromString: Transformation<DateTime.TimeZone, string> = transformOrFail<DateTime.TimeZone, string>(
  {
    decode: (s) => {
 ...
 * @since 4.0.0
 */
export const dateTimeUtcFromString: Transformation<DateTime.Utc, string> = transformOrFail<DateTime.Utc, string>({
  decode: (s) => {
 ...
 * @since 4.0.0
 */
export const dateTimeZonedFromString: Transformation<DateTime.Zoned, string> = transformOrFail<DateTime.Zoned, string>({
  decode: (s) => {
