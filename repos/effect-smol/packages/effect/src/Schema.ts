 ...
 * @since 4.0.0
 */
export interface withDecodingDefaultTypeKey<S extends Top> extends decodeTo<
  withDecodingDefaultKey<toType<S>>,
  optionalKey<S>
> {
...
export function withDecodingDefaultTypeKey<S extends Top>(
  ...
  return (self: S): withDecodingDefaultTypeKey<S> => {
    return toType(self).pipe(withDecodingDefaultKey<toType<S>>(defaultValue, options), encodeTo(optionalKey(self)))
  }
}
...
export function withDecodingDefaultType<S extends Top>(
  ...
  return (self: S): withDecodingDefaultType<S> => {
    return toType(self).pipe(withDecodingDefault<toType<S>>(defaultValue, options), encodeTo(optional(self)))
  }
}
...
export function isLengthBetween(minimum: number, maximum: number, annotations?: Annotations.Filter) {
  ...
  return makeFilter<{ readonly length: number }>((input) => input.length >= minimum && input.length <= maximum, {
    expected:
      minimum === maximum
...
export function isSizeBetween(minimum: number, maximum: number, annotations?: Annotations.Filter) {
  minimum = Math.max(0, Math.floor(minimum))
  maximum = Math.max(0, Math.floor(maximum))
  return makeFilter<{ readonly size: number }>((input) => input.size >= minimum && input.size <= maximum, {
    expected:
      minimum === maximum
...
export function OptionFromOptionalNullOr<S extends Top>(
  ...
  const noneValue =
    onNoneEncoding === null ? (null as S['Type'] | null | undefined) : (undefined as S['Type'] | null | undefined)
 ...
 * @since 4.0.0
 */
export interface CauseReason<E extends Top, D extends Top> extends declareConstructor<
        ...
        switch (input._tag) {
          case 'Fail':
            return Effect.mapBothEager(Parser.decodeUnknownEffect(error)(input.error, options), {
              ...
              onFailure: (issue) =>
                new Issue.Composite(ast, Option_.some(input), [new Issue.Pointer(['error'], issue)]),
            })
          case 'Die':
 ...
 * @since 4.0.0
 */
export interface HashMap<Key extends Top, Value extends Top> extends declareConstructor<
...
export function Chunk<Value extends Top>(value: Value): Chunk<Value> {
  const schema = declareConstructor<Chunk_.Chunk<Value['Type']>, Chunk_.Chunk<Value['Encoded']>, ChunkIso<Value>>()(
    [value],
    ([value]) => {
      const values = ArraySchema(value)
      return (input, ast, options) => {
...
export const URL: URL = instanceOf(globalThis.URL, {
  ...
  expected: 'URL',
  toCodecJson: () => link<globalThis.URL>()(URLString, Transformation.urlFromString),
...
export const Date: Date = instanceOf(globalThis.Date, {
  ...
  expected: 'Date',
  toCodecJson: () => link<globalThis.Date>()(DateString, Transformation.dateFromString),
...
export const BigDecimal: BigDecimal = declare(BigDecimal_.isBigDecimal, {
  ...
  expected: 'BigDecimal',
  toCodecJson: () => link<BigDecimal_.BigDecimal>()(BigDecimalString, Transformation.bigDecimalFromString),
  toArbitrary: () => (fc) =>
    fc.tuple(fc.bigInt(), fc.integer({ min: 0, max: 20 })).map(([value, scale]) => BigDecimal_.make(value, scale)),
...
export const Uint8Array: Uint8Array = instanceOf(globalThis.Uint8Array<ArrayBufferLike>, {
  ...
  expected: 'Uint8Array',
  toCodecJson: () =>
    link<globalThis.Uint8Array<ArrayBufferLike>>()(Base64String, Transformation.uint8ArrayFromBase64String),
...
export const DateTimeUtc: DateTimeUtc = declare((u) => DateTime.isDateTime(u) && DateTime.isUtc(u), {
  ...
  toCodecJson: () => link<DateTime.Utc>()(String, Transformation.dateTimeUtcFromString),
  toArbitrary: () => (fc, ctx) =>
...
export const TimeZoneOffset: TimeZoneOffset = declare(DateTime.isTimeZoneOffset, {
  ...
  toCodecJson: () => link<DateTime.TimeZone.Offset>()(Number, Transformation.timeZoneOffsetFromNumber),
  toArbitrary: () => (fc) =>
...
export const TimeZoneNamed: TimeZoneNamed = declare(DateTime.isTimeZoneNamed, {
  ...
  toCodecJson: () => link<DateTime.TimeZone.Named>()(TimeZoneNamedString, Transformation.timeZoneNamedFromString),
  toArbitrary: () => (fc) =>
    fc.constantFrom(
...
export const TimeZone: TimeZone = declare(DateTime.isTimeZone, {
  ...
  toCodecJson: () => link<DateTime.TimeZone>()(TimeZoneString, Transformation.timeZoneFromString),
  toArbitrary: () => (fc) =>
    fc.oneof(
      fc.integer({ min: -12 * 60 * 60 * 1000, max: 14 * 60 * 60 * 1000 }).map((n) => DateTime.zoneMakeOffset(n)),
      fc.constantFrom(
 ...
 * @since 4.0.0
 */
export const DateTimeZoned: DateTimeZoned = declare((u) => DateTime.isDateTime(u) && DateTime.isZoned(u), {
  typeConstructor: {
  ...
  toCodecJson: () => link<DateTime.Zoned>()(DateTimeZonedString, Transformation.dateTimeZonedFromString),
  toArbitrary: () => (fc, ctx) =>
    fc
      .tuple(
        fc.date({
