 ...
 * @category Done
 */
export const isDoneFailure = <E>(failure: Cause.Reason<E>): failure is Cause.Fail<E & Cause.Done<any>> =>
 ...
 * @category Done
 */
export const filterDone: <E>(input: Cause.Cause<E>) => Result.Result<Cause.Done.Only<E>, Cause.Cause<ExcludeDone<E>>> =
  Filter.composePassthrough(Cause.findError, (e) => (Cause.isDone(e) ? Result.succeed(e) : Result.fail(e))) as any
...
export const filterDoneVoid: <E extends Cause.Done>(
  input: Cause.Cause<E>,
) => Result.Result<Cause.Done, Cause.Cause<Exclude<E, Cause.Done>>> = Filter.composePassthrough(Cause.findError, (e) =>
 ...
 * @category Done
 */
export const filterNoDone: <E>(input: Cause.Cause<E>) => Result.Result<Cause.Cause<ExcludeDone<E>>, Cause.Cause<E>> =
