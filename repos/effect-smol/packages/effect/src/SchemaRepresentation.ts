...
const $ArraysMeta = Schema.Union([$IsMinLength, $IsMaxLength, $IsLengthBetween, $IsUnique]).annotate({
 ...
 * @since 4.0.0
 */
export const $SizeMeta = Schema.Union([$IsMinSize, $IsMaxSize, $IsSizeBetween]).annotate({ identifier: 'SizeMeta' })
 ...
 * @since 4.0.0
 */
export const $DeclarationMeta = Schema.Union([$DateMeta, $SizeMeta]).annotate({ identifier: 'DeclarationMeta' })
