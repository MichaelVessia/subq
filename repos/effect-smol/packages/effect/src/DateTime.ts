...
export declare namespace DateTime {
   ...
   * @category models
   */
  export type UnitSingular = 'millisecond' | 'second' | 'minute' | 'hour' | 'day' | 'week' | 'month' | 'year'

  /**
   * @since 3.6.0
   * @category models
   */
  export type UnitPlural = 'milliseconds' | 'seconds' | 'minutes' | 'hours' | 'days' | 'weeks' | 'months' | 'years'
 ...
 */
export class CurrentTimeZone extends Context.Service<CurrentTimeZone, TimeZone>()('effect/DateTime/CurrentTimeZone') {}
 ...
 * @since 3.6.0
 */
export const layerCurrentZoneNamed: (zoneId: string) => Layer.Layer<CurrentTimeZone, IllegalArgumentError> = flow(
  Internal.zoneMakeNamedEffect,
