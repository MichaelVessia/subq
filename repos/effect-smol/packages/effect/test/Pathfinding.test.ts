 ...
 */
const assertPath = (terrain: Terrain, actual: Option.Option<Graph.PathResult<number>>, sequence: Sequence) => {
 ...
 */
const sequenceFromPath = (terrain: Terrain, path: Option.Option<Graph.PathResult<number>>): Sequence | undefined => {
