...
describe('toSchema', () => {
  ...
  describe('toSchemaDefaultReviver', () => {
    ...
    it('Option', () => {
      assertToSchemaWithReviver(Schema.Option(Schema.String), `Schema.Option(Schema.String)`)
      assertToSchemaWithReviver(Schema.Option(Schema.URL), `Schema.Option(Schema.URL)`)
    })
    ...
    it('Redacted', () => {
      assertToSchemaWithReviver(Schema.Redacted(Schema.String), `Schema.Redacted(Schema.String)`)
    })
    ...
    it('Chunk', () => {
      assertToSchemaWithReviver(Schema.Chunk(Schema.String), `Schema.Chunk(Schema.String)`)
    })

    it('ReadonlySet', () => {
      assertToSchemaWithReviver(Schema.ReadonlySet(Schema.String), `Schema.ReadonlySet(Schema.String)`)
    })
    ...
    it('HashSet', () => {
      assertToSchemaWithReviver(Schema.HashSet(Schema.String), `Schema.HashSet(Schema.String)`)
    })
