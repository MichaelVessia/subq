        ...
        { schema: A },
        {
          ...
          references: {
            recursives: {
              ...
              Suspend_: makeCode(`Schema.suspend((): Schema.Codec<A> => A)`, `A`),
            },
          },
        },
      )
        ...
        { schema: A },
        {
          ...
          references: {
            recursives: {
              ...
              Objects_: makeCode(`Schema.Struct({ "a": Schema.optionalKey(A) })`, `{ readonly "a"?: A }`),
            },
          },
        },
      )
  ...
  describe('ReadonlySet', () => {
    it('ReadonlySet(String)', () => {
      assertSchema(
        ...
        {
          codes: makeCode(`Schema.ReadonlySet(Schema.String)`, 'globalThis.ReadonlySet<string>'),
        },
      )
    })
  ...
  describe('HashMap', () => {
    it('HashMap(String, Number)', () => {
      assertSchema(
        ...
        {
          codes: makeCode(`Schema.HashMap(Schema.String, Schema.Number)`, 'HashMap.HashMap<string, number>'),
