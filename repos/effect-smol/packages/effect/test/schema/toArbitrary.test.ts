...
describe('Arbitrary generation', () => {
  ...
  describe('checks', () => {
    ...
    it('isPropertiesLengthBetween(2, 2)', () => {
      verifyGeneration(Schema.Record(Schema.String, Schema.Number).check(Schema.isPropertiesLengthBetween(2, 2)))
    })
  ...
  describe('ReadonlyMap', () => {
    ...
    it('isSizeBetween(2, 2)', () => {
      verifyGeneration(Schema.ReadonlyMap(Schema.String, Schema.Number).check(Schema.isSizeBetween(2, 2)))
    })
  })
