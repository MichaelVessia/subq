...
describe('toJsonSchemaDocument', () => {
  ...
  describe('String', () => {
    ...
    describe('checks', () => {
      ...
      describe('isLengthBetween', () => {
        it('String', () => {
          assertJsonSchemaDocument(Schema.String.check(Schema.isLengthBetween(2, 2)), {
            schema: {
              type: 'string',
        ...
        it('Array', () => {
          assertJsonSchemaDocument(Schema.Array(Schema.String).check(Schema.isLengthBetween(2, 2)), {
            schema: {
              type: 'array',
              items: {
                type: 'string',
        ...
        it('NonEmptyArray', () => {
          assertJsonSchemaDocument(Schema.NonEmptyArray(Schema.String).check(Schema.isLengthBetween(2, 2)), {
            schema: {
              type: 'array',
              prefixItems: [
                {
      ...
      it('isUUID', () => {
        assertJsonSchemaDocument(Schema.String.annotate({ description: 'description' }).check(Schema.isUUID()), {
          schema: {
            type: 'string',
  ...
  describe('Union of literals', () => {
    ...
    it('nested literals', () => {
      const schema = Schema.Union([Schema.Literal('a'), Schema.Literals(['b', 'c'])])
      assertJsonSchemaDocument(schema, {
        schema: {
          type: 'string',
          enum: ['a', 'b', 'c'],
          ...
          }),
          {
            schema: {
              ...
              properties: {
                ...
                b: {
                  anyOf: [{ type: 'string', description: 'b' }, { type: 'null' }],
                  allOf: [
                    {
                      description: 'b-key',
                    },
  ...
  describe('Record', () => {
    it('Record(String, Never)', () => {
      ...
      assertJsonSchemaDocument(Schema.Record(Schema.String, Schema.Never.annotate({ description: 'a' })), {
        schema: {
          type: 'object',
          additionalProperties: {
            description: 'a',
