...
describe('toEquivalence', () => {
  ...
  it('TimeZoneOffset', () => {
    ...
    assertTrue(equivalence(DateTime.zoneMakeOffset(3 * 60 * 60 * 1000), DateTime.zoneMakeOffset(3 * 60 * 60 * 1000)))
    assertFalse(equivalence(DateTime.zoneMakeOffset(3 * 60 * 60 * 1000), DateTime.zoneMakeOffset(4 * 60 * 60 * 1000)))
  })
  ...
  it('TimeZone', () => {
    ...
    assertTrue(equivalence(DateTime.zoneMakeOffset(0), DateTime.zoneMakeOffset(0)))
    assertFalse(equivalence(DateTime.zoneMakeOffset(0), DateTime.zoneMakeOffset(3 * 60 * 60 * 1000)))
  })
