...
describe('HttpClientRequest', () => {
  describe('appendUrl', () => {
    it('joins segments without slashes', () => {
      const request = HttpClientRequest.get('base').pipe(HttpClientRequest.appendUrl('users'))
    ...
    it('no-ops on empty path', () => {
      const request = HttpClientRequest.get('base').pipe(HttpClientRequest.appendUrl(''))
  ...
  describe('hash', () => {
    ...
    it('returns none for invalid url', () => {
      const request = HttpClientRequest.get('http://example.com').pipe(HttpClientRequest.setUrl('http://[::1'))
  ...
  describe('web conversions', () => {
    ...
    it('toWebResult returns failure for invalid url', () => {
      const request = HttpClientRequest.get('http://localhost').pipe(HttpClientRequest.setUrl('http://[::1'))
