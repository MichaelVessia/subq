  ...
  describe('constructors', () => {
    ...
    describe('reasonFromHttpStatus', () => {
      ...
      it('should map 5xx to InternalProviderError', () => {
        assert.strictEqual(AiError.reasonFromHttpStatus({ status: 500 })._tag, 'InternalProviderError')
        assert.strictEqual(AiError.reasonFromHttpStatus({ status: 502 })._tag, 'InternalProviderError')
        assert.strictEqual(AiError.reasonFromHttpStatus({ status: 503 })._tag, 'InternalProviderError')
      })
