...
describe('Function', () => {
  describe('dual', () => {
    it('arity 2 - data-first', () => {
      const sum = F.dual<(that: number) => (self: number) => number, (self: number, that: number) => number>(
        2,
    ...
    it('arity 3 - data-first', () => {
      const add3 = F.dual<(b: number, c: number) => (a: number) => number, (a: number, b: number, c: number) => number>(
        3,
