...
describe('Data', () => {
  ...
  describe('TaggedClass', () => {
    ...
    it('with fields: args excludes _tag', () => {
      ...
      expect<ConstructorParameters<typeof Person>>().type.toBe<[args: { readonly name: string }]>()
    })
  })
  ...
  describe('Error', () => {
    ...
    it('with fields: args is the fields object', () => {
      ...
      expect<ConstructorParameters<typeof MyError>>().type.toBe<[args: { readonly message: string }]>()
    })
  })
  ...
  describe('TaggedError', () => {
    ...
    it('with fields: args excludes _tag', () => {
      ...
      expect<ConstructorParameters<typeof MyError>>().type.toBe<[args: { readonly reason: string }]>()
    })
  })
  ...
  describe('TaggedEnum', () => {
    it('should be able to create a tagged enum', () => {
      ...
      expect<Extract<TE, { _tag: 'A' }>>().type.toBe<{ readonly _tag: 'A'; readonly required: string }>()
      expect<Extract<TE, { _tag: 'B' }>>().type.toBe<{ readonly _tag: 'B'; readonly optional?: number }>()
    })
  ...
  describe('taggedEnum', () => {
    it('should be able to create a concrete tagged enum', () => {
      ...
      >()
      const isA = $is('A')
      expect(isA).type.toBe<(u: unknown) => u is { readonly _tag: 'A'; readonly required: string }>()
      const isB = $is('B')
      expect(isB).type.toBe<(u: unknown) => u is { readonly _tag: 'B'; readonly optional?: number }>()
    })
