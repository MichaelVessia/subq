...
describe('Array', () => {
  ...
  it('isArrayEmpty', () => {
    ...
    // should play well with `Option.liftPredicate`
    expect(Option.liftPredicate(Array.isArrayEmpty)).type.toBe<<A>(a: Array<A>) => Option.Option<[]>>()
  })
  ...
  it('isArrayNonEmpty', () => {
    ...
    // should play well with `Option.liftPredicate`
    expect(Option.liftPredicate(Array.isArrayNonEmpty)).type.toBe<<A>(a: Array<A>) => Option.Option<[A, ...Array<A>]>>()
  })
  ...
  it('groupBy', () => {
    ...
    expect(Array.groupBy([1, 2, 3], (n) => (n > 0 ? ('positive' as const) : ('negative' as const)))).type.toBe<
  ...
  it('partition', () => {
    ...
    expect(Array.partition).type.not.toBeCallableWith(numbersOrStrings, (_item: string | number) => true)
  })
  ...
  it('filter', () => {
    ...
    expect(Array.filter).type.not.toBeCallableWith(numbersOrStrings, (_item: string | number) => Result.succeed(_item))
  })
  ...
  it('takeWhile', () => {
    ...
    expect(Array.takeWhile).type.not.toBeCallableWith(numbersOrStrings, (_item: string | number) =>
      Result.succeed(_item),
    )
  })
  ...
  it('dropWhile', () => {
    ...
    expect(Array.dropWhile).type.not.toBeCallableWith(numbersOrStrings, (_item: string | number) =>
      Result.succeed(_item),
    )
  })
  ...
  it('unzip', () => {
    ...
    // NonEmptyArray
    expect(Array.unzip(hole<Array.NonEmptyReadonlyArray<[string, number]>>())).type.toBe<
      [[string, ...Array<string>], [number, ...Array<number>]]
    >()
    expect(pipe(hole<Array.NonEmptyReadonlyArray<[string, number]>>(), Array.unzip)).type.toBe<
      [[string, ...Array<string>], [number, ...Array<number>]]
    >()
  })
  ...
  it('separate', () => {
    ...
    expect(Array.separate(hole<Iterable<Result.Result<number, string> | Result.Result<boolean, Date>>>())).type.toBe<
      [Array<string | Date>, Array<number | boolean>]
    >()
    expect(
      Array.separate(hole<Iterable<Result.Result<number, string>> | Iterable<Result.Result<boolean, Date>>>()),
  ...
  it('getSuccesses', () => {
    ...
    expect(
      Array.getSuccesses(hole<Iterable<Result.Result<number, string> | Result.Result<boolean, Date>>>()),
    ).type.toBe<Array<number | boolean>>()
    expect(
      Array.getSuccesses(hole<Iterable<Result.Result<number, string>> | Iterable<Result.Result<boolean, Date>>>()),
    ).type.toBe<Array<number | boolean>>()
  })
  ...
  it('getFailures', () => {
    ...
    expect(Array.getFailures(hole<Iterable<Result.Result<number, string> | Result.Result<boolean, Date>>>())).type.toBe<
      Array<string | Date>
    >()
    expect(
      Array.getFailures(hole<Iterable<Result.Result<number, string>> | Iterable<Result.Result<boolean, Date>>>()),
