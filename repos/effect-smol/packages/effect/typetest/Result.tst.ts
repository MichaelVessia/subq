...
describe('Result', () => {
  ...
  it('fromNullishOr', () => {
    ...
    expect(Result.fromNullishOr(nullableString, () => new Error())).type.toBe<Result.Result<string, Error>>()
    ...
    expect(Result.fromNullishOr(nullableObject, () => new Error())).type.toBe<Result.Result<{ a: string }, Error>>()
  ...
  it('filterOrFail', () => {
    ...
    // @tstyche fixme -- This doesn't work but it should
    expect(Result.filterOrFail(literal$Error, Predicate.isString, (_s: string) => 'b' as const)).type.toBe<
      Result.Result<'a', 'b' | Error>
    >()
    expect(
      pipe(
        literal$Error,
    ...
    expect(Result.filterOrFail(literal$Error, predicateUnknown, (_s: string) => 'b' as const)).type.toBe<
      Result.Result<'a', 'b' | Error>
    >()
    expect(
      pipe(
