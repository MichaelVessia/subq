...
describe('AtomHttpApi', () => {
  it('should include middleware errors in query and mutation atoms', () => {
    ...
    expect<Atom.Failure<typeof mutation>>().type.toBe<EndpointError | MiddlewareError | MiddlewareClientError>()

    expect<Atom.Failure<typeof query>>().type.toBe<EndpointError | MiddlewareError | MiddlewareClientError>()
  })
  ...
  it('should mirror HttpApiClient response-only error behavior', () => {
    ...
    expect<Atom.Failure<typeof mutation>>().type.toBe<MiddlewareError | MiddlewareClientError>()
  })
})
