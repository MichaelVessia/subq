...
describe('LanguageModel', () => {
  describe('generateText', () => {
    ...
    it('supports toolkit unions in options', () => {
      ...
      type ToolkitUnionHandlers = Tool.Handler<'ToolWithRequestContext'> | Tool.Handler<'FailureModeErrorTool'>
      ...
      expect<ProgramError>().type.toBe<AiError.AiError | { readonly message: string }>()
      expect<ProgramRequirements>().type.toBe<LanguageModel.LanguageModel | RequestContext | ToolkitUnionHandlers>()
    })
    ...
    it('extracts services and tools from toolkit unions', () => {
      ...
      >()
      expect<LanguageModel.ExtractTools<{ readonly toolkit: ToolkitUnion }>>().type.toBe<ToolkitUnionTools>()
    })
