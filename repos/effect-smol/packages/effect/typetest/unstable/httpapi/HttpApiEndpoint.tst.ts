...
describe('HttpApiEndpoint', () => {
  describe('params option', () => {
    ...
    it('should accept a record of fields', () => {
      ...
      expect(endpoint['~Params']).type.toBe<HttpApiEndpoint.StringTree<Schema.Struct<{ id: Schema.Finite }>>>()
    })
    ...
    it('should accept a Struct', () => {
      ...
      expect(endpoint['~Params']).type.toBe<
        HttpApiEndpoint.StringTree<Schema.Struct<{ readonly a: Schema.Finite; readonly b: Schema.Finite }>>
      >()
    })
  })
  ...
  describe('error option', () => {
    it('should accept a schema', () => {
      ...
      expect(endpoint['~Error']).type.toBe<HttpApiEndpoint.Json<Schema.Struct<{ readonly a: Schema.String }>>>()
    })
