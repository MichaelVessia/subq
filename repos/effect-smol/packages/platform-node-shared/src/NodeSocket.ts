 ...
 * @category tags
 */
export class NetSocket extends Context.Service<NetSocket, Net.Socket>()('@effect/platform-node/NodeSocket/NetSocket') {}
 ...
 * @category layers
 */
export const layerNet: (options: Net.NetConnectOpts) => Layer.Layer<Socket.Socket, Socket.SocketError> = Function.flow(
  makeNet,
