      ...
      it.effect('extracts multiple text parts', () =>
        Effect.gen(function* () {
          ...
          Effect.provide(
            makeTestLayer({
              body: {
                output: [makeTextOutput('First'), makeTextOutput('Second', { id: 'msg_456' })],
              },
            }),
          ),
        ),
...
const makeDefaultResponse = (overrides: Partial<Generated.Response> = {}): Generated.Response => ({
  id: 'resp_test123',
  object: 'response',
...
const decodeToolParamsFromStream = (parts: ReadonlyArray<any>, toolCallId: string): Record<string, unknown> => {
...
const makeTextOutput = (text: string, overrides: Partial<Generated.OutputMessage> = {}): Generated.OutputMessage => ({
  type: 'message',
  id: 'msg_123',
...
const makeUsage = (overrides: Partial<Generated.ResponseUsage> = {}): Generated.ResponseUsage => ({
  input_tokens: 10,
  output_tokens: 20,
  total_tokens: 30,
