...
/** @internal */
export const resolveFinishReason = (finishReason: string | null | undefined): Response.FinishReason =>
  Predicate.isNotNullish(finishReason) ? finishReasonMap[finishReason] : 'other'
