...
const annotateRequest = (span: Span, request: typeof Generated.ChatGenerationParams.Encoded): void => {
...
const tryJsonSchema = <S extends Schema.Top>(schema: S, method: string, transformer: LanguageModel.CodecTransformer) =>
  Effect.try({
