...
export const make = Effect.fnUntraced(function* (
  ...
  const buildChatCompletionStream = (
    response: HttpClientResponse.HttpClientResponse,
  ): [HttpClientResponse.HttpClientResponse, Stream.Stream<ChatStreamingResponseChunkData, AiError.AiError>] => {
  ...
  const createChatCompletionStream: Service['createChatCompletionStream'] = (payload) =>
    httpClientOk
      ...
      .pipe(
        ...
        Effect.catchTag('HttpClientError', (error) => Errors.mapHttpClientError(error, 'createChatCompletionStream')),
      )
