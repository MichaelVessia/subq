...
const SharedStorage = Layer.mergeAll(RunnerStorage.layerMemory, MessageStorage.layerMemory).pipe(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* Effect.gen(function* () {
          ...
          yield* client.Process(TestPayload.make({ id: 'req-1', amount }), { discard: true })
