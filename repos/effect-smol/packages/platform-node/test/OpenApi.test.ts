...
describe('OpenAPI spec', () => {
  describe('api', () => {
    ...
    it('AdditionalSchemas', () => {
      const Api = HttpApi.make('api').annotate(HttpApi.AdditionalSchemas, [Schema.String.annotate({ identifier: 'A' })])
      const spec = OpenApi.fromApi(Api)
  ...
  describe('endpoint', () => {
    ...
    describe('payload option', () => {
      ...
      describe('POST', () => {
        it('NoContent', () => {
          const Api = HttpApi.make('api').add(
            HttpApiGroup.make('group').add(HttpApiEndpoint.post('a', '/a', { payload: HttpApiSchema.NoContent })),
          )
          const spec = OpenApi.fromApi(Api)
        ...
        it('NoContent + payload', () => {
          const Api = HttpApi.make('api').add(
            HttpApiGroup.make('group').add(
              HttpApiEndpoint.post('a', '/a', { payload: [HttpApiSchema.NoContent, Schema.String] }),
            ),
          )
          const spec = OpenApi.fromApi(Api)
        ...
        describe('encodings', () => {
          ...
          it('asJson + contentType', () => {
            const Api = HttpApi.make('api').add(
              HttpApiGroup.make('group').add(
                HttpApiEndpoint.post('a', '/a', {
                  payload: Schema.String.pipe(HttpApiSchema.asJson({ contentType: 'application/problem+json' })),
                }),
              ),
            )
            const spec = OpenApi.fromApi(Api)
          ...
          it('asFormUrlEncoded', () => {
            const Api = HttpApi.make('api').add(
              HttpApiGroup.make('group').add(
                HttpApiEndpoint.post('a', '/a', {
                  payload: Schema.Struct({ a: Schema.String }).pipe(HttpApiSchema.asFormUrlEncoded()),
                }),
              ),
            )
            const spec = OpenApi.fromApi(Api)
      ...
      describe('encodings', () => {
        it('asJson + contentType', () => {
          const Api = HttpApi.make('api').add(
            HttpApiGroup.make('group').add(
              HttpApiEndpoint.get('a', '/a', {
                success: Schema.String.pipe(HttpApiSchema.asJson({ contentType: 'application/problem+json' })),
              }),
            ),
          )
          const spec = OpenApi.fromApi(Api)
        ...
        it('asFormUrlEncoded', () => {
          const Api = HttpApi.make('api').add(
            HttpApiGroup.make('group').add(
              HttpApiEndpoint.get('a', '/a', {
                success: Schema.Struct({ a: Schema.String }).pipe(HttpApiSchema.asFormUrlEncoded()),
              }),
            ),
          )
          const spec = OpenApi.fromApi(Api)
        ...
        it('union with top level encoding', () => {
          const Api = HttpApi.make('api').add(
            HttpApiGroup.make('group').add(
              HttpApiEndpoint.get('a', '/a', {
                success: Schema.Union([Schema.Struct({ a: Schema.String }), Schema.Struct({ b: Schema.String })]).pipe(
        ...
        it('asJson + astText', () => {
          const Api = HttpApi.make('api').add(
            HttpApiGroup.make('group').add(
              HttpApiEndpoint.get('a', '/a', {
                success: [Schema.String, Schema.String.pipe(HttpApiSchema.asText())],
              }),
            ),
          )
          const spec = OpenApi.fromApi(Api)
